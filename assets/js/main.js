...
var showStat = function showStat() {
    client.get('https://www.googleapis.com/youtube/v3/channels?part=statistics&id=UC_x5XG1OV2P6uZZ5FSM9Ttw&key=AIzaSyAk-6HA611Wq9Or9dELINuHLd2Thj5JN1Q', function (response) {
        console.log(JSON.parse(response).items[0].statistics.subscriberCount);
    });
    client.get('https://www.googleapis.com/youtube/v3/channels?part=snippet&id=UCVswRUcKC-M35RzgPRv8qUg&key=AIzaSyAk-6HA611Wq9Or9dELINuHLd2Thj5JN1Q', function (response) {
